...
public class MybatisServicePlugin extends PluginAdapter {
    ...
    private FullyQualifiedJavaType resource;
	...
	public boolean validate(List<String> warnings) {
		...
		if (enableAnnotation) {
            ...
            resource = new FullyQualifiedJavaType("javax.annotation.Resource");
		}
		return true;
	}
	...
	protected void addServiceImpl(TopLevelClass topLevelClass,IntrospectedTable introspectedTable, String tableName, List<GeneratedJavaFile> files) {
        ...
        topLevelClass.addJavaDocLine("* "+tableName+"Service");
        topLevelClass.addJavaDocLine("* ");
        topLevelClass.addJavaDocLine("* @author 王欣");
        topLevelClass.addJavaDocLine("* @version v1.0");
        //interfaze.addJavaDocLine("* @copy 鸿旭图码");
	...
	private void addImport(Interface interfaces, TopLevelClass topLevelClass) {
		...
		if (enableAnnotation) {
			topLevelClass.addImportedType(service);
			topLevelClass.addImportedType(resource);
		}
	}
